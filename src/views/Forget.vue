<!--
 * @Author: your name
 * @Date: 2020-11-30 10:03:39
 * @LastEditTime: 2020-11-30 18:05:32
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \front\src\views\Forget.vue
-->
<!--  -->
<template>
              ...
              <form method="post">
                <div class="layui-form-item">
                  ...
                  <ValidationProvider rules="required|email" v-slot="{ errors }">
                    ...
                    <!-- <span class="error" v-if="errors[0]">请输入正确的邮箱地址</span> -->
                  </ValidationProvider>
                </div>
                <div class="layui-form-item">
                  ...
                  <ValidationProvider rules="required|length:4" v-slot="{ errors }">
                    ...
                    <span class="error" v-if="errors[0]">请输入验证码</span>
                  </ValidationProvider>
                  <div class="layui-form-mid">
                    <div
                ...
                <div class="layui-form-item">
                  <button class="layui-btn" alert="1" @click="submit()">提交</button>
                </div>
              </form>
            </div>
          </div>
...
<script>
import { forget, getCode } from '@/api/login.js'
export default {
  components: {},
  data() {
    return {
