<!--
 * @Author: your name
 * @Date: 2021-03-05 17:01:04
 * @LastEditTime: 2021-03-10 17:20:17
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \front\src\components\modules\editor\Preview.vue
-->
<!--  -->
<template>
  <transition name="fade">
    <div id="preview" class="layui-layer-page layui-layer-prompt edit-content">
