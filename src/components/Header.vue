<!--
 * @Author: your name
 * @Date: 2020-11-30 10:41:22
 * @LastEditTime: 2021-03-03 10:09:32
    ...
    <div class="layui-container">
      ...
      <ul class="layui-nav fly-nav layui-hide-xs">
        ...
        <li class="layui-nav-item">
          <router-link to="/user123"
            ><i class="iconfont icon-iconmingxinganli"></i>案例</router-link
          >
        </li>
        <li class="layui-nav-item">
          ...
          <li class="layui-nav-item" @mouseover="show()" @mouseleave="hide()">
            <a class="fly-nav-avatar" href="javascript:;">
              ...
              <i class="layui-badge fly-badge-vip layui-hide-xs" v-show="userInfo.isVip !== '0'"
                >VIP3{{ userInfo.isVip }}</i
              >
              <img :src="userInfo.pic" />
            </a>
            <dl class="layui-nav-child layui-anim-upbit" :class="{ 'layui-show': isHover }">
              <dd>
